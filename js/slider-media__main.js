var swiper__media__main = null;
var mediaQuerySize = 700;

function catalogSliderInit () {
  if (!swiper__media__main) {
    swiper__media__main = new Swiper('.swiper-container__media-main', {
        // Optional parameters
        ...
        // Navigation arrows
        navigation: {
          nextEl: '.swiper-button-next__media-main',
          prevEl: '.swiper-button-prev__media-main',
        },
        ...
        breakpoints: {
            ...
            768: {
              pagination: {
                el: '.swiper-pagination__media-main',
                clickable: true,
                type: 'custom',
...
function catalogSliderDestroy () {
  if (swiper__media__main) {
    swiper__media__main.destroy();
    swiper__media__main = null;
  }
}
