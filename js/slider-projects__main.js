var swiper__projects__main = null;
var mediaQuerySize = 700;

function catalogSliderInit () {
  if (!swiper__projects__main) {
    swiper__projects__main = new Swiper('.swiper-container__projects-main', {
        // Optional parameters
        ...
        // Navigation arrows
        navigation: {
          nextEl: '.swiper-button-next__projects-main',
          prevEl: '.swiper-button-prev__projects-main',
        },
        ...
        breakpoints: {
            ...
            768: {
              pagination: {
                el: '.swiper-pagination__projects-main',
                clickable: true,
                type: 'custom',
...
/*function catalogSliderDestroy () {
  if (swiper__projects__main) {
    swiper__projects__main.destroy();
    swiper__projects__main = null;
  }
}
