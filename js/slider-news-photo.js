var swiper__news__photo = null;
var mediaQuerySize = 700;

function catalogSliderInit () {
  if (!swiper__news__photo) {
    swiper__news__photo = new Swiper('.swiper-container__media-photo', {
        // Optional parameters
        ...
        // Navigation arrows
        navigation: {
          nextEl: '.swiper-button-next__media-photo',
          prevEl: '.swiper-button-prev__media-photo',
        },
        ...
        breakpoints: {
            ...
            768: {
              pagination: {
                el: '.swiper-pagination__media-photo',
                clickable: true,
                type: 'custom',
...
function catalogSliderDestroy () {
  if (swiper__news__photo) {
    swiper__news__photo.destroy();
    swiper__news__photo = null;
  }
}
