var swiper__news__main = null;
var mediaQuerySize = 700;

function catalogSliderInit () {
  if (!swiper__news__main) {
    swiper__news__main = new Swiper('.swiper-container__news-main', {
        // Optional parameters
        ...
        // Navigation arrows
        navigation: {
          nextEl: '.swiper-button-next__news-main',
          prevEl: '.swiper-button-prev__news-main',
        },
        ...
        breakpoints: {
            ...
            768: {
              pagination: {
                el: '.swiper-pagination__news-main',
                clickable: true,
                type: 'custom',
...
function catalogSliderDestroy () {
  if (swiper__news__main) {
    swiper__news__main.destroy();
    swiper__news__main = null;
  }
}
